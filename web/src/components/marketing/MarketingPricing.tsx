...
const COPY = {
  en: {
    ...
    faqTitle: "Questions",
    faqs: [
      { q: "Is the free tier actually free forever?", a: "Yes. 1,000 credits on signup + 100 credits refreshed daily. No card. No expiry. No trial." },
      { q: "What happens when credits run out?", a: "Wait for tomorrow's 100-credit refresh, top up one-time, or subscribe for more monthly credits." },
      { q: "Can I cancel anytime?", a: "Yes. From Settings → Manage subscription. You keep access until the end of your current period." },
      { q: "How do I unlock adult mode?", a: "Self-attest you're 18+ in Settings — one toggle, no ID check. Off by default." },
      { q: "How do AI tiers work?", a: "Standard (Gemini Flash) and Pro (Claude Sonnet) — auto-routed by your selected model. Adult mode is a toggle on either tier. Free tier is Standard only." },
    ],
    ...
    freeCreditsLine: "1,000 signup · 100 daily",
    navHow: "How it works",
    navMemory: "Memory",
    navPricing: "Pricing",
    navBegin: "Begin",
  ...
  zhHant: {
    ...
    faqTitle: "常見問題",
    faqs: [
      { q: "Free tier 真係永遠免費？", a: "係 · 1,000 credits 註冊送 + 每日 100 credits 自動補。唔使信用卡 · 冇 expiry · 冇 trial。" },
      { q: "Credits 用完點算？", a: "等聽日 100 credits 補返 · 或者一次性買 top-up · 或者升級訂閱拎更多 monthly credits。" },
      { q: "可唔可以隨時取消？", a: "可以 · 任何時候喺 Settings → 管理訂閱裡面 cancel。當前 billing period 玩到完先停權。" },
      { q: "成人模式點解鎖？", a: "喺 Settings 自己確認年滿 18 歲 · 撳一個掣就得 · 唔使驗證 ID。預設關閉。" },
      { q: "唔同 model 點揀？", a: "Standard（Gemini Flash）同 Pro（Claude Sonnet）兩個 tier · 自動按你揀嘅 model 路由。成人模式喺兩個 tier 都係一個掣。Free tier 限 Standard。" },
    ],
    canceledTitle: "訂閱取消",
    ...
    freeCreditsLine: "1,000 註冊送 · 每日 100",
    navHow: "點玩",
    navMemory: "記憶",
    navPricing: "訂價",
    navBegin: "立即開始",
  ...
  zhHans: {
    ...
    faqTitle: "常见问题",
    faqs: [
      { q: "Free tier 真的永远免费？", a: "是 · 1,000 credits 注册送 + 每日 100 credits 自动补。不用信用卡 · 没有 expiry · 没有 trial。" },
      { q: "Credits 用完怎么办？", a: "等明天 100 credits 补回 · 或者一次性买 top-up · 或者升级订阅拿更多 monthly credits。" },
      { q: "可以随时取消吗？", a: "可以 · 任何时候在 Settings → 管理订阅里面 cancel。当前 billing period 玩到完才停权。" },
      { q: "成人模式怎么解锁？", a: "在 Settings 自己确认年满 18 岁 · 按一个键就行 · 不用验证 ID。默认关闭。" },
      { q: "不同 model 怎么选？", a: "Standard（Gemini Flash）和 Pro（Claude Sonnet）两个 tier · 自动按你选的 model 路由。成人模式在两个 tier 都是一个键。Free tier 限 Standard。" },
    ],
    canceledTitle: "订阅取消",
    ...
    backToHome: "← 返主页",
    creditsLine: (n: number) => `每月 ${n.toLocaleString()} credits`,
    freeCreditsLine: "1,000 注册送 · 每日 100",
    navHow: "怎么玩",
    navMemory: "记忆",
    navPricing: "订价",
    navBegin: "立即开始",
