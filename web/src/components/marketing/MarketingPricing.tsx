...
const COPY = {
  en: {
    ...
    faqs: [
      ...
      { q: "How do AI tiers work?", a: "Standard (Claude Sonnet) and Pro (Claude Opus) — auto-routed by your selected model. Adult mode is a toggle on either tier. Free tier is Standard only." },
    ],
  ...
  zhHant: {
    ...
    faqs: [
      ...
      { q: "唔同 model 點揀？", a: "Standard（Claude Sonnet）同 Pro（Claude Opus）兩個 tier · 自動按你揀嘅 model 路由。成人模式喺兩個 tier 都係一個掣。Free tier 限 Standard。" },
    ],
    canceledTitle: "訂閱取消",
  ...
  zhHans: {
    ...
    faqs: [
      ...
      { q: "不同 model 怎么选？", a: "Standard（Claude Sonnet）和 Pro（Claude Opus）两个 tier · 自动按你选的 model 路由。成人模式在两个 tier 都是一个键。Free tier 限 Standard。" },
    ],
    canceledTitle: "订阅取消",
